<template>
    <div class="task" v-if="vis">
        <div class="task__header">
            <div class="icon task-priority--5">
                <phone-icon v-if="taskInfo.type === 'phone'"></phone-icon>
                <question-icon v-if="taskInfo.type === 'question'"></question-icon>
            </div>
            <h3>{{ taskInfo.type }}</h3>
